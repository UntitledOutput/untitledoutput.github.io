...
* 3D Audio using [OpenAL](openal.org)
* Debug UI with ImGui
* Entity-Component System 1[^fn1]
* Lighting System w/ Cubemaps
* Networking using [enet](lsalzman/enet) (wip)
* Particle Systems (wip)
* 3D & 2D Physics using bullet & [Box2D](box2d.org)
* Primitive rendering
...
I have worked on a few projects to test the capabilities of the engine, from an attempted Tomodachi Life fan project (before they announced a sequel), to a recreation of Nintendo's Tofu Prototype which eventually transformed into Splatoon.

-- note to self: add links & images of projects
